...
if (isset($_SESSION['logged_in'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = "INSERT INTO medical_records (record_id,user_id,symptoms, diagnosis, Date_of_Diagnosis, Specialist_Consulted, Treatment_Process, Medicine_Prescribed) 
  			  VALUES('$record_id','$user_id','$sypmtoms' , '$diagnosis', '$date', '$dr', '$trtmnt', '$medicines')";
