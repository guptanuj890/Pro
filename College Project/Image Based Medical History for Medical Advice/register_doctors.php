...
if (isset($_POST['submit'])) {
    ...
    $doctor_id = strtoupper(uniqid('MLD'));
    $dob = mysqli_real_escape_string($db, $_POST['dob']);
    $gender = mysqli_real_escape_string($db, $_POST['gender']);
    $state = mysqli_real_escape_string($db, $_POST['state']);
    $phone = mysqli_real_escape_string($db, $_POST['phone']);
    $specialist = mysqli_real_escape_string($db, $_POST['specialist']);
    $medical_degree = mysqli_real_escape_string($db, $_POST['medical_degree']);
    $email = mysqli_real_escape_string($db, $_POST['email']);
    $password = mysqli_real_escape_string($db, $_POST['password']);
    $password = md5($password);
    $query = "INSERT INTO doctors (`doctor_id`, `name`, `dob`, `gender`, `state`, `phone`, `specialist`, `medical_degree`, `email`, `password`) 
          VALUES('$doctor_id' , '$name', '$dob', '$gender', '$state', '$phone', '$specialist', '$medical_degree', '$email', '$password')";
        ...
        <div>
            <div>
                <div class="col-lg-offset-1 col-lg-10 box" style="vertical-align: middle; padding: 20px">
                    <form action="register_doctors.php" class="content-section" method="POST">
                        <h1 style="font-size: 50px; ">REGISTERATION FOR DOCTORS</h1>
<?php
...
?>
                        ...
                        <div class="row form-input-group">
                            <label style="text-align: left" class="col-lg-2">Specialist</label><input name="specialist" type="text" class="input-box col-lg-4">
                            <label style="text-align: center" class="col-lg-2">Medical Degree</label><input name="medical_degree" type="text" class="input-box col-lg-4">
                        </div>
                        <div class="row form-input-group">
