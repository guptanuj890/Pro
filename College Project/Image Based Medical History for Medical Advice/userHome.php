...
if (isset($_SESSION['logged_in'])) {
    ...
    $past_surgeries = $row['PastSurgeries'];
    $ongoing_medications = $row['OngoingMedications'];
    ?>
    <html>
        <head>
            <meta charset="UTF-8">
                ...
                <div class="col-lg-offset-1 col-lg-10 box" style="vertical-align: middle; padding: 50px; font-family: Varela Round ">
                    <div class="row"> 
                        <div class="col-lg-6">
                            ...
                            <h2 style="font-size: 30px; "><b><?php echo $user_id ?></b></h2>
                        ...
                        <div class="col-lg-6">
                            <h1 style="font-size: 50px; ">BloodGroup: <?php echo $bg ?></h1>
                            <h2 style="font-size: 30px; ">Allergies: <b><?php echo $allergies ?></b></h2>
                            <h3 style="font-size: 30px; "> Past Surgeries: <?php echo $past_surgeries ?></h3>
                            <h3 style="font-size: 30px; "> OngoingMedications: <?php echo $ongoing_medications ?></h3>
                        </div> 
                        <!-- <div class="col-lg-5 box" style="vertical-align: middle; font-family: Varela Round; background-color: #e9e9e9;  border-radius: 20px">
                            <h1 style="font-size: 25px; "><?php echo $user_id ?><br><?php echo $name ?></h1>
                            <br><br>
