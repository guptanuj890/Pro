                    ...
                    <div class="row">
                        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                            ...
                            <div style="float: left;" class="row">
                                ...
                                <div style="border: solid 1px white; border-radius: 10px; padding: 10px; font-family: Montserrat; margin-right: 10px;"><a href="login.php" style="color: white;">Sign Up</a> / <a href="register_user_doctor.php" style="color: white;">Sign In</a></div>
                            </div>
                        </div>
                        <!-- <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                            <img src="illustrations/doctor-colour.svg"style="width: 25vw; height: 20vw;  display: block;   margin-left: auto;  margin-right: auto;">
                        </div>  -->
                    </div>
                </div> 
            </div>
