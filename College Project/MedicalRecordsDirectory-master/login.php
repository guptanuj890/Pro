    ...
    <body style=" height:  100%; background-color: #f5f5f5; padding-bottom: 10px;">
        ...
        <div style="color: #1e78ff;">
            <div style="padding-top: 5%; vertical-align: central;">
                ...
                <br><br><br>
                <center style="font-family: Montserrat; font-size: 35px;color: black" class="col-12" >New user? <a href="register_user_doctor.php" style="color: #1e78ff ">Register</a></center><br>
            </div>
        </div>
    </body>
</html>
